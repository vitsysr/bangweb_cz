...
export const LABELS: LabelRegistry = {
    ...
    GameOptionsTooltip: {
        max_players:            "Numero massimo di giocatori per questa partita.",
        add_bots:               "Riempi gli slot rimanenti dei giocatori con bot.",
        character_choice:       "Abilita la scelta su N personaggi prima dell'inizio della partita.",
        all_characters:         "Ogni giocatore sceglie da tutti i personaggi disponibili.",
        ...
        prompt_target_immunity: "Avvisa quando viene bersagliato un giocatore che è immune alla carta giocata.",
        only_base_characters:   "Aggiungi solo i personaggi della versione base del gioco.",
        allow_bot_rejoin:       "Permetti agli spettatori di prendere controllo dei bot.",
    ...
    ExpansionTooltip: {
        ...
        frontier:               "Un'espansione della community, da AlmostJosiah",
        crazy_greygory:         "Tutti i giocatori sono Greygory Deck senza limitazioni",
    },

    PlayerIcon: {
        'icon-winner':          "Vincitore",
        'icon-origin':          "Giocatore origine",
        'icon-target':          "Giocatore bersaglio",
        'icon-turn':            "Giocatore di turno",
        'icon-dead':            "Morto",
        'icon-ghost':           "Fantasma",
        'icon-skip-turn':       "Salterà il turno",
        'icon-dynamite':        "Candelotto di dinamite",
    ...
    ui: {
        ...
        NUM_SPECTATORS: "Numero di spettatori",
        LOBBY_STATE: "Stato della lobby",
