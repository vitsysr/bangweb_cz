...
LOG_HOROUS_SHADOW: (player) => <>{player} is treated as an eliminated player for the next round</>,
    ...
    STATUS_LAURA_BILLION: (card, target_card) =>                            <>{card} ... you can discard a card to draw {target_card}.</>,
    STATUS_LAURA_BILLION_OTHER: (player, card, target_card) =>              <>{card} ... {player} can discard a card to draw {target_card}.</>,
    ...
    STATUS_CAN_DRAW: (card, ncards) =>                                      <>{card} ... you can draw {ncards === 1 ? 'a card' : `${ncards} cards`}.</>,
    STATUS_CAN_DRAW_OTHER: (card, player, ncards) =>                        <>{card} ... {player} can draw {ncards === 1 ? 'a card' : `${ncards} cards`}.</>,
    STATUS_BALLAD_STEAL: (card, player) =>                                  <>{card} ... you can steal a card from {player}'s hand.</>,
    ...
    STATUS_FALCON_OTHER: (card, player, target) =>                          <>{card} ... {target} is looking at {player}'s hand</>,
    STATUS_FALCON_TARGET: (card, player) =>                                 <>{card} ... {player} wants to look at your hand.</>,
    STATUS_FALCON_TARGET_OTHER: (target, card, player) =>                   <>{card} ... {player} wants to look at {target}'s hand.</>,
    STATUS_GRIZZLY: (card) =>                                               <>{card} attacks you!</>,
    STATUS_GRIZZLY_OTHER: (player, card) =>                                 <>{card} against {player}</>,
    STATUS_STAMPEDE: (card) =>                                              <>{card} ... you must discard every card in front of you.</>,
    STATUS_STAMPEDE_OTHER: (target, card) =>                                <>{card} ... {target} must discard every card in game.</>,
    STATUS_TRACK_PLAYER: (card) =>                                          <>Choose who to track for {card}.</>,
    ...
    LOG_DRAWN_CARDS_FOR: (player, ncards, card) =>                          <>{player} draws {ncards === 1 ? "a card" : `${ncards} cards`} for {card}</>,
    ...
    LOG_TRACKED_PLAYER: (player, card, target) =>                           <>{player} tracks {target} for {card}</>,
    LOG_MOVE_TRAP_ON: (card, player, target) =>                             <>{player} moves {card} on {target}</>,
